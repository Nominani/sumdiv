...
(async() => {
    ...
    var cunt = document.createElement("div")
    cunt.style.opacity = "0"
    cunt.style.textAlign = "center"
    cunt.style.cursor = "default"
    document.getElementsByTagName("center")[0].after(cunt)

    cunt.insertAdjacentHTML('afterbegin', `<input id="fsy" value="10" style="width: 30px;"><input id="numb" style="width: 90px;"><input id="osy" value="16" style="width: 30px;"><div id="resu"></div>
    <div> </div><div>_______________</div><div id="hinto"> </div>`);

    var resu = document.getElementById("resu")
    var fsy = document.getElementById("fsy")
    var numb = document.getElementById("numb")
    var osy = document.getElementById("osy")
    var hinto = document.getElementById("hinto")
    var otv = document.getElementById("otv")

    function chnum() {
        try {
            resu.innerText = parseInt(numb.value, parseInt(fsy.value)).toString(parseInt(osy.value))
        } catch {}
    }
    ...
    numb.onchange = chnum
    osy.onchange = chnum
    hinto.innerText = document.getElementsByName("a_form_id[]")[0].title
    ...
    document.addEventListener("keydown", function(e) {
        ...
        if (e.key == "z") {
            if (cunt.style.opacity == "0") {cunt.style.opacity = "0.05"} else {cunt.style.opacity = "0"}
        }
    })
