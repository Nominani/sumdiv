...
*/
    ...
    function getHash(strr) {
        var hash = 0, i, chr;
        if (strr.length === 0) return hash;
    ...
    var cont = document.evaluate("//*[contains(@style, 'padding-left:30px; padding-right:30px')]", document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue.getElementsByTagName("img");
    if (cont.length > 0) {
        question += getHash(getBase64Image(cont[0]))
    }
